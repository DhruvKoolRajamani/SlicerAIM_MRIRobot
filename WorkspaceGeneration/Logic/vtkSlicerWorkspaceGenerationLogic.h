...
// .NAME vtkSlicerWorkspaceGenerationLogic - slicer logic class for volumes manipulation
// .SECTION Description
...
class VTK_SLICER_WORKSPACEGENERATION_MODULE_LOGIC_EXPORT vtkSlicerWorkspaceGenerationLogic :
...
private:
  ...
  vtkSlicerWorkspaceGenerationLogic(const vtkSlicerWorkspaceGenerationLogic&); // Not implemented
